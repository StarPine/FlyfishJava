...
public class GameArgs implements Parcelable {
	...
	private String account_id = MyApplication.context.getSharedPreferences("user_info", 0).getString("asdk_accountid", "0");
	private String session_id = MyApplication.context.getSharedPreferences("user_info", 0).getString("asdk_sessionid", "0");

	private String customorderid = OrderManager.getorder();// 商户订单
